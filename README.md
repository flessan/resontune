...
**Flow** (`/game`) is a built-in horizontal rhythm game: pick a song (Preview
Beat, a local file, or a catalog track), prep difficulty, then play. Timing
is locked to a dedicated audio clock; local music never leaves the device.
